            ...
            <div class="modal-content">
                <form @submit.prevent="SEND()">
                    ...
                    <div class="modal-body pt-0 px-4">
                        ...
                        <p class="text-uppercase text-sm">Información de País</p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="form-control-label">Nombre de País</label>
...
export default {
    ...
    computed: {
        OPEN: function() {
            let _this = this
            if(_this.method == 'PUT') {
                axios({url: '/countries/' + _this.id, method: 'GET' })
                .then((resp) => {
                    if (resp.data.result) {
    ...
    methods:{
        ...
        SEND: function(){
            ...
            if(_this.count == 1){
                ...
                setTimeout(function() {
					axios({url: '/countries' + method, method: 'POST', data: form })
					.then((resp) => {
						if(resp.data.result) {
							_this.icon = 'success'
